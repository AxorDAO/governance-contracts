...
hardhatTask('deploy:phase-1', 'Phase 1 of governance deployment.')
  ...
  .addParam('axorTokenAddress', 'Previously deployed Axor token address', undefined, types.string)
  .addParam('governorAddress', 'Previously deployed Axor governor address', undefined, types.string)
