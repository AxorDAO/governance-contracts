...
hardhatTask('deploy:safety-module-compensation-proposal', 'Create proposal to compensate Safety Module stakers.')
  ...
  .addParam('axorTokenAddress', 'Address of the deployed AXOR token contract', undefined, types.string)
  .addParam('governorAddress', 'Address of the deployed AxorGovernor contract', undefined, types.string)
