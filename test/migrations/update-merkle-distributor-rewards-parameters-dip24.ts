...
import { AxorGovernor__factory, AxorToken__factory, MerkleDistributorV1__factory } from '../../types';
...
export async function updateMerkleDistributorRewardsParametersDIP24ViaProposal({
  ...
  if (config.UPDATE_MERKLE_DISTRIBUTOR_REWARDS_PARAMETERS_DIP24_PROPOSAL_ID !== null) {
    ...
    log('Waiting for voting update-merkle-distributor-rewards-parameters-dip24 to begin');
    writeIdProposal({ id: proposalId.toNumber(), proposal: 'updateMerkleDistributorRewardsParametersDIP24Proposal' });
