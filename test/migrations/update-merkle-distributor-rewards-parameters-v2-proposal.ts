...
export async function updateMerkleDistributorRewardsParametersV2ViaProposal({
  ...
  if (config.UPDATE_MERKLE_DISTRIBUTOR_REWARDS_PARAMETERS_v2_PROPOSAL_ID !== null) {
    ...
    log('Waiting for voting update-merkle-distributor-rewards-parameters-v2 to begin');
    writeIdProposal({ id: proposalId.toNumber(), proposal: 'updateMerkleDistributorRewardsParametersV2Proposal' });
