...
export async function updateMerkleDistributorRewardsParametersViaProposal({
  ...
  if (config.UPDATE_MERKLE_DISTRIBUTOR_REWARDS_PARAMETERS_PROPOSAL_ID !== null) {
    ...
    log('Waiting for voting update-merkle-distributor-rewards-parameters to begin');
    writeIdProposal({ id: proposalId.toNumber(), proposal: 'updateMerkleDistributorRewardsParametersProposal' });
