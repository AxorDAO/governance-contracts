...
import axorTokenAbi from '../../../abi/contracts/governance/token/AxorToken.sol/AxorToken.json';
...
export default class AxorTokenService extends BaseService<AxorToken> {
  ...
  constructor(
    ...
    super(config, AxorToken__factory);
