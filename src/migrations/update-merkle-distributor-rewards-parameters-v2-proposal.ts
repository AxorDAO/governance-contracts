...
export async function updateMerkleDistributorRewardsParametersV2Proposal({
  proposalIpfsHashHex,
  governorAddress,
  ...
  log(`Creating Update Merkle Distributor Rewards Parameters v2 proposal with proposer ${deployerAddress}.\n`);
